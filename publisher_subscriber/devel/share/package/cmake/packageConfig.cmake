...
if("TRUE" STREQUAL "TRUE")
  set(package_SOURCE_PREFIX /home/artem/git/ros_repo/publisher_subscriber/src/package)
  set(package_DEVEL_PREFIX /home/artem/git/ros_repo/publisher_subscriber/devel)
  set(package_INSTALL_PREFIX "")
  set(package_PREFIX ${package_DEVEL_PREFIX})
else()
  set(package_SOURCE_PREFIX "")
  set(package_DEVEL_PREFIX "")
  set(package_INSTALL_PREFIX /home/artem/git/ros_repo/publisher_subscriber/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'package' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'artem <artem@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/artem/git/ros_repo/publisher_subscriber/src/package/${idir}'.  Ask the maintainer 'artem <artem@todo.todo>' to fix it.")
    endif()
